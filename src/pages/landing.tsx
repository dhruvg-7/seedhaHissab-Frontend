...
const COMPARISON = [
  ['Feature', 'WhatsApp / Excel / Memory', 'SeedhaHisaab'],
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-base tracking-tight">SeedhaHisaab</span>
          </div>
      ...
      >
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            SeedhaHisaab keeps the complete financial picture — across projects, people, and time.
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-3 mt-10">
            ...
            <div className="px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold text-base shadow-lg">
              SeedhaHisaab — one place for all of it
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <blockquote className="text-xl sm:text-2xl font-medium text-foreground leading-relaxed mb-6 tracking-tight">
            "SeedhaHisaab is still evolving. Every feature comes from a real operational problem someone actually faced — not a product roadmap meeting."
          </blockquote>
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-foreground">SeedhaHisaab</span>
          </div>
